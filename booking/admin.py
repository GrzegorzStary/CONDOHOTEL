...
"""
This class is used to customize the admin interface for the Reservation model.
It displays guest details and reservation period, and allows filtering and search.
"""
